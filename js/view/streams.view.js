var ViewStreams = function( cfg ) {
	...
	this.template = function( o ) {
		...
		html += '<li>';
		html += 	'<a class="images" href="/#channel/'+ o.channel.name +'">';
		...
		if (window.psdevLazyLoad.isCached( o.preview.medium ))
			...
			html += '<div class="preview" data-image="'+ o.preview.medium +'" style="background-image: url(/img/loading.gif); background-size: auto;"></div>';
